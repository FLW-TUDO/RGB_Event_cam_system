...
object_name = 'human_hupwagen_kronen_blue_klt_1'
...
json_path_object = root_dir + '/vicon_data/human.json'
path_event_cam_left_img = root_dir  + '/event_cam_left/e2calib/'
path_event_cam_right_img = root_dir + '/event_cam_right/e2calib/'
output_dir = root_dir + '/annotation/'
output_dir_rgb = root_dir + '/annotation/human_rgb'
output_dir_event_cam_left = root_dir + '/annotation/human_ec_left'
output_dir_event_cam_right = root_dir + '/annotation/human_ec_right'
