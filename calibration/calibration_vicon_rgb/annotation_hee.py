...
data_path = '/home/eventcamera/data/KLT/vicon_data/'
json_path_camera_sys = os.path.join(data_path, 'event_cam_sys.json')
json_path_object = os.path.join(data_path, 'object1.json')
json_path_event_cam_left = '/home/eventcamera/data/KLT/event_cam_left/'
json_path_event_cam_right = '/home/eventcamera/data/KLT/event_cam_right/'
# with open(json_path_camera, 'r') as f:
#    data_camera = json.load(f)

rgb_image_path = '/home/eventcamera/data/KLT/rgb/'
